      ...
      <section className="hero">
        <div className="left-hero">
          ...
          <div className="hero-buttons" id="herobtn">
            <button className="no-acc">
              <img src={noacc} alt="rightarrow" />
              Create your Profile
            </button>
            <button className="have-acc">I have an account</button>
          </div>
          <div className="popular-skills">
            <ul className="demo-skills">
              <SkillTag icon={ml} text="Machine Learning" bgColor="#cbffe4"/>
              <SkillTag icon={cybersec} text="Cyber Security" bgColor="#fff9aa"/>
              <SkillTag icon={react} text="FullStack Development" bgColor="#a5dfff"/>
